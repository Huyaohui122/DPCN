...
def query_ball_point(radius, nsample, xyz, new_xyz):#nsample:16 32 128
    """
    Input:
    ...
    #print(type(group_first))
    #11print(group_first.shape)
    mask = group_idx == N
...
class PointNetSetAbstractionMsg(nn.Module):
    ...
    def forward(self, xyz, points):
        ...
        for i, radius in enumerate(self.radius_list):
            K = self.nsample_list[i]#16 32 128
